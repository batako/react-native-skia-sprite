      ...
      const detailed = await Promise.all(
        files.map(async (name) => {
          ...
          const isImage =
            ...
            /\.(png|jpe?g|gif|webp|bmp|heic|heif|tiff)$/i.test(name);
          ...
          return {
            ...
            modified: info.modificationTime ?? undefined,
            isImage,
          } satisfies FileEntry;
        }),
      );
      const filtered = detailed.filter((entry): entry is FileEntry => Boolean(entry));
